...
Alle folgenden Argumente können ähnlich für die Präzision des Punktschätzers gemacht werden (etwa Standardfehler oder Breite des Konfidenzintervalls)
...
FPR = `r compute.ppv(power=.20, alpha=.05, r=.5)`
...
FPR = `r compute.ppv(power=.20, alpha=.05, r=.2)`
...
.large[Stichprobengröße ist nicht alles....]
