...
.read_more[] Geringe Teststärke ist ein Problem für Sie, da die Wahrscheinlichkeit für Type-II-Fehler, d.h., ihre Chancen wahre Effekte zu verpassen steigt
...
.read_more[] Geringe Teststärke ist ein Problem für ein Forschungsfeld, da die Wahrscheinlichkeit, dass berichtete Effekte falsch sind steigt (Die Anzahl der Falsch-Positiven Befunde steigt)
...
Teststärke: Pr(Reject H0 | H0 is false)

Falschpositivrate: Welcher Anteil von Studien, die ein signifikantes Ergebnis berichten irren:
